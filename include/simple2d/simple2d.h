...
typedef struct {
    ...
    int orig_width;
    int orig_height;
    GLuint  program; // Program used when drawing the image
...
typedef struct {
    ...
    int clip_width;
    int clip_height;
    GLuint  program; // Shader program used when drawing the sprite
    GLfloat rotate;  // Rotation angle in degrees
    GLfloat rx;      // X coordinate to be rotated around
    GLfloat ry;      // Y coordinate to be rotated around
    GLfloat tx1;
...
typedef struct {
    ...
    int width;
    int height;
    GLuint  program; // Shader program used when drawing the text
    GLfloat rotate;  // Rotation angle in degrees
    GLfloat rx;      // X coordinate to be rotated around
    GLfloat ry;      // Y coordinate to be rotated around
} S2D_Text;
